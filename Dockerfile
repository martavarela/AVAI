...
RUN pip3 install --no-cache-dir matplotlib==3.8.2 pydicom==2.4.3 pynetdicom==2.0.2 scikit-image scipy wheel==0.42.0
RUN pip3 install --no-cache-dir monai==1.3.1 numpy==1.26.2 torch==2.3.0 medcam==0.1.21 SimpleITK==2.3.1 
